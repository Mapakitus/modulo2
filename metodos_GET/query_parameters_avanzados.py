...
def get_analytics(
    ...
    return {
        ...
        "data": f"Resultados filtrados con precio mínimo {min_price} euros",
        "total_found": max_results   
    }

#URL para probar: http://localhost:8000/analytics?min_price=9.99&max_results=10
...
def advanced_search(
        ...
        category: Optional[str] = Query(None, min_lenght=2),
